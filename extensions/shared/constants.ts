/**
 * Constants shared between the todo and plan-mode extensions.
 *
 * These customType strings identify branch entries that both extensions read.
 * They MUST stay identical across extensions (plan-mode seeds todo state and
...
/** customType for persisted plan-mode state snapshots. */
